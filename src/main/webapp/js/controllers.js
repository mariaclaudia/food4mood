...
/**
 * The root out4foodApp module.
 *
 * @type {out4foodApp|*|{}}
 */
var out4foodApp = out4foodApp || {};
 ...
 *
 */
out4foodApp.controllers = angular.module('conferenceControllers', ['ui.bootstrap']);
 ...
 */
out4foodApp.controllers.controller('MyProfileCtrl',
 ...
 */
out4foodApp.controllers.controller('CreateConferenceCtrl',
    function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
 ...
 */
out4foodApp.controllers.controller('ShowConferenceCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
 ...
 */
out4foodApp.controllers.controller('ConferenceDetailCtrl', function ($scope, $log, $routeParams, HTTP_ERRORS) {
    $scope.conference = {};
 ...
 *
 */
out4foodApp.controllers.controller('RootCtrl', function ($scope, $location, oauth2Provider) {
 ...
 *
 */
out4foodApp.controllers.controller('OAuth2LoginModalCtrl',
 ...
 */
out4foodApp.controllers.controller('DatepickerCtrl', function ($scope) {
