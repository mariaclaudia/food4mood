package com.out4food.spi;

import static com.out4food.service.OfyService.factory;
import static com.out4food.service.OfyService.ofy;
...
import com.out4food.domain.Conference;
import com.out4food.form.ConferenceForm;
import com.out4food.domain.AppEngineUser;
import com.out4food.domain.Profile;
import com.out4food.domain.form.ProfileForm;
import com.googlecode.objectify.Key;
import com.googlecode.objectify.Objectify;
import com.googlecode.objectify.Work;
import com.out4food.Constants;

/**
 * Defines Out4Food APIs.
 */
/**
 ...
 **/
	...
	@Api(
	        ...
	        description = "Out4foodl API for creating and querying events," +
	                	  " and for creating and getting user Profiles"
	)

	public class Out4foodAPI {
		
		
		private static final Logger LOG = Logger.getLogger(Out4foodAPI.class.getName());
